...
def sort_by_cohort(filename):
    ...
    for line in filename:
        ...
        if tokenized[4] == "Spring 2015":
            spring_15.append(tokenized[0] + " " + tokenized[1])
        elif tokenized[4] == "Winter 2015":
            winter_15.append(tokenized[0] +  " " + tokenized[1])
        elif tokenized[4] == "Summer 2015":
            summer_15.append(tokenized[0]+ " " + tokenized[1])
        else:
            tas.append(tokenized[0] + " " + tokenized[1])
